...
const About = () => {
  return (
    <section>
         <div className="flex bg-pink-600 w-[95%] m-10 py-5 bg-red-200 flex-col justify-center items-center  max-md:max-w-full max-md:px-5 max-sm:m-1">
          <div className="flex max-w-[80%] flex-col  max-md:max-w-full max-md:my-10">
            <div className="flex justify-center items-center flex-col gap-10 items-start max-md:max-w-full max-md:flex-wrap">
              ...
              <div className="flex justify-center items-center  flex-col max-md:max-w-full">
                <div className="text-red-600 text-2xl font-bold text-5xl uppercase max-md:max-w-full max-sm:text-l">
                  About
                </div>
                <div className="text-black text-2xl font-bold uppercase mt-5 max-md:max-w-full max-md:text-4xl max-md:leading-[55px] max-sm:text-sm">
              ...
              <img
                ...
                className="object-contain object-center w-full overflow-hidden max-w-[50%] grow basis-[0%] max-md:max-w-full"
                alt=""
              />
            </div>
            <div className="flex justify-center items-center flex-col gap-5 mt-28 pr-20 items-start max-md:max-w-full max-md:flex-wrap max-md:mt-10 max-md:pr-5">
              ...
              <div className="text-white text-2xl font-bold whitespace-nowrap justify-center items-stretch bg-orange-600 px-16 py-6 max-md:px-5">
                Let’s get started
              </div>
            </div>
          </div>
